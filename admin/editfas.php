...
<body>
	...
	<div style=" margin-bottom: 100px; width: 50%;" class="container">
		     ...
		     ?></h2>
		  	...
		  	<div class="card-body">
		  		<div style="margin-left:10px; " class="row mt-2 mx-auto">
		  			...
		  			$id=$_GET['id'];
				  	$data = mysqli_query($koneksi,"SELECT * FROM fasilitas  WHERE idfasilitas = '$id'");
		...
		<form method="post" action="fungsi/editf.php" enctype="multipart/form-data">
			<div class="form-group">
				<input type="hidden" name="id" value="<?php echo $d['idfasilitas']; ?>">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="nama" class="form-control" placeholder="nama fasilitas" id="nama" required="required" value="<?php echo $d['namafas']; ?>">
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="des" class="form-control" placeholder="keterangan" id="des" required="required" value="<?php echo $d['deskrip']; ?>">
					</div>
				</div>
			</div>
			<div class="row">
