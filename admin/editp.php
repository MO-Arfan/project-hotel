...
<body>
	...
	<div style=" margin-bottom: 100px; width: 50%;" class="container">
		     ...
		     ?></h2>
		  	...
		  	<div class="card-body">
		  		<div style="margin-left:10px; " class="row mt-2 mx-auto">
		  			...
		  			$id=$_GET['id'];
				  	$data = mysqli_query($koneksi,"SELECT * FROM login  WHERE iduser = '$id'");
		...
		<form method="post" action="fungsi/epetus.php">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="username" class="form-control" placeholder="Username" id="Username" required="required" value="<?php echo $d['username']; ?>">
					</div>
				</div>
			</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select class="form-select" name="level" id="selek" required="required" aria-label="Default select example">
                              <option selected="selected" value="<?php echo $d['level']?>"><?php echo $d['level']?></option>
