...
<body>
	...
	<!-- isi -->
<div style="margin-top:100px; width: 800px;" class="container">
	<div style="border:0;" class="card text-center" >
	  ...
	  <div class="card-body">
	    ...
	    <h1 style="text-transform:uppercase;"><?php
		     ...
		     echo "$nama"
		     ?></h1>
	    <img style="width: 350px; height: 200px;" src="../img/hti.png">
	    <h5 class="card-text mt-5 mb-5">Utamakan keselamatan bekerja ya.</h5>
