...
<body>
	...
	<div style=" margin-bottom: 100px; width: 50%;" class="container">
		...
		<form method="post" action="fungsi/tmbk.php" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="tipe" class="form-control" placeholder="tipe kamar" id="tipe" required="required" autocomplete="off">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label for="harga">Harga</label>
						<input type="text" name="harga" class="form-control" placeholder="harga" id="harga" required="required" autocomplete="off">
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="stok" class="form-control" placeholder="stok kamar" id="stok" required="required" autocomplete="off">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label for="fas">Fasilitas</label>
						<input type="text" name="fas" class="form-control" placeholder="fasilitas" id="fas" required="required" autocomplete="off">
					</div>
				</div>
			</div>
