...
if(isset($_POST['cari'])){
	$key = $_POST['keyword'];
	$data = mysqli_query($koneksi,"SELECT * FROM tamu WHERE
																	nama LIKE '%$key%' OR
																	idtamu LIKE '%$key%' OR
	  	...
	  	<div class="container-fluid">
	    	...
	    	<div class="collapse navbar-collapse" id="navbarSupportedContent">
	    		<ul class="nav nav-tabs me-auto mb-2 mb-lg-0">
					  ...
					  <li class="nav-item">
					    <a class="nav-link active" aria-current="page" href="daftartamu.php">Tamu</a>
					  </li>
					  <li class="nav-item">
...
<div style="margin-top:100px;" class="container">
  ...
  <thead>
    <tr>
      <th class="col" scope="col">id Tamu</th>
      ...
      <th class="col" scope="col">Telepon</th>
  ...
  <tbody>
  	...
  	while ($d = mysqli_fetch_array($data)) {
  		?>
  		<tr>
    		<td class="pt-2"><?php echo $d['idtamu']; ?></td>
	     	<td class="pt-2"><?php echo $d['nama']; ?></td>
		    <td class="pt-2"><?php echo $d['username']; ?></td>
		    <td class="pt-2"><?php echo $d['email']; ?></td>
		    <td class="pt-2"><?php echo $d['alamat']; ?></td>
		    <td class="pt-2"><?php echo $d['telepon']; ?></td>
		    <td class="pt-2"><a href="editamu.php?id=<?= $d['idtamu']?>" class="btn btn-primary btn-sm">EDIT</a> | <a href="fungsi/hapust.php?id=<?= $d['idtamu']?>" class="btn btn-danger btn-sm">HAPUS</a></td>
	    </tr>
